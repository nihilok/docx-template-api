...
const NewTemplateView = ({getTemplates}) => {
  ...
  return (
      <>
        ...
        {showHelp ?
            <div style={{margin: '1rem 0 0 0'}}><small>Templates should be in the form of a .docx file, formatted as you would like the final document to be. Variables with distinct names should be declared between double {'{{}}'}</small>
